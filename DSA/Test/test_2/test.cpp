...
private:
    ...
    struct Node {
        ...
        Node(int data) : prev(nullptr), key(data), next(nullptr) {};
    };
...
public:
    ...
    void push_back(int data) {
        ...
        // Gán nút mới vào kế vị trí nút tạm và gán con trỏ prev vào nút trước nút mới
        curr->next = newNode;
        newNode->prev = curr;
    }
    ...
    void push_at(int data, int position) {
        ...
        // Kiểm tra nếu nút phía trước là nullptr
        if (newNode->next)
